from facerecognition.inception_v1 import preprocessing as pp
from facerecognition.inception_v1 import postprocessing as pop

class Recognize:
    def __init__(self, model_loader, depth):
        self.depth = depth
        self.model_dict = model_loader.load_inception_v1_model(True)
