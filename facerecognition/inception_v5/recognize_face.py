from facerecognition.inception_v5 import preprocessing as pp
from facerecognition.inception_v5 import postprocessing as pop

class Recognize:
    def __init__(self, model_loader, depth):
        self.model_dict = model_loader.load_inception_v5_model(True)
    ...
    def post_process(self, faces_recognized):
