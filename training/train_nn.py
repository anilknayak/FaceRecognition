...
class TrainNeuralNetwork:
    def __init__(self, commuter, depth=1):
        ...
        self.resultwriter = self.commuter.context.resultwritter.create_result_obj('cnn')
    ...
    def train(self):
        ...
        # Disctionary of [Class1:Images List, Class2:Images List]
        ...
        # Returns Images List, Label Number List, Class & label Number Mapping
        ...
        self.model_obj = self.commuter.prepare_deep_network("configuration/nn_architecture/cnn_net_new.config", depth=self.depth)
    ...
    def train_model(self, data_obj, model_obj):
        ...
        with self.sess.as_default():
            ...
            for i in range(self.model_obj.training_epochs):
                ...
                epoch_loss = 0
                for j in tqdm(range(0, len(images), model_obj.batch_size), desc="Training Epoch CNN : "+str(i+1)):
    ...
    def save_model(self, saver, label_number_mapping):
        ...
        path = os.path.join(model_dir_path, "classifier_"+str(self.depth)+".pickle")
